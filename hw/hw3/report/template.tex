...
\section{Baseline Architecture (30 pts)}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[width=1\textwidth]{figures/conv_num_kernels.png}
    ...
    \begin{figure}[!htb]
        ...
        \begin{subfigure}{.5\textwidth}
          \centering
          \includegraphics[width=1\linewidth]{figures/learning_rate/conv_lr_train.png}
          \caption{Train Loss}
          \label{fig:lr_sub1}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
          \centering
          \includegraphics[width=1\linewidth]{figures/learning_rate/conv_lr_valid.png}
          \caption{Valid Loss}
          \label{fig:lr_sub2}
        \end{subfigure}
        \caption{Effect of Different Learning Rate}
        \label{fig:conv_lr}
        \end{figure}
